...
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户账号表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of user_account
-- ----------------------------
INSERT INTO `user_account` VALUES (15, '81f40b6f1bb341969bdce1827b317efb', 0.00, 0.00, '2022-07-25 09:54:08', '2022-07-25 09:54:08', 0);
INSERT INTO `user_account` VALUES (16, 'ddd1066e996f45a5bf735d54deff86b5', 0.00, 0.00, '2022-07-26 18:33:53', '2022-07-26 18:33:53', 0);
INSERT INTO `user_account` VALUES (17, '08c679e45f924926a2b91c10afb8b192', 97500.00, 0.00, '2022-07-26 18:38:10', '2022-07-26 18:38:10', 0);
...
CREATE TABLE `user_bind`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `agent_id` int(0) NOT NULL DEFAULT 0 COMMENT '商户id',
  ...
  `is_deleted` tinyint(0) NOT NULL DEFAULT 0 COMMENT '逻辑删除(1:已删除，0:未删除)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户绑定表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of user_bind
-- ----------------------------
INSERT INTO `user_bind` VALUES (15, 999888, '2', '小王', '18482020182', '111222333444555', '251253712312321', NULL, 'http://localhost:3000/user', 'http://localhost/api/core/userBind/notify', 1658714026571, '81f40b6f1bb341969bdce1827b317efb', '123456', 0, '2022-07-25 09:54:08', '2022-07-25 09:54:08', 0);
INSERT INTO `user_bind` VALUES (16, 999888, '3', '小红', '17683004240', '510522222222222222', '231233333333333333', NULL, 'http://localhost:3000/user', 'http://localhost/api/core/userBind/notify', 1658831623348, 'ddd1066e996f45a5bf735d54deff86b5', '123456', 0, '2022-07-26 18:33:53', '2022-07-26 18:33:53', 0);
INSERT INTO `user_bind` VALUES (17, 999888, '4', '小李', '18482020180', '510511111111111111', '3413241111111111111', NULL, 'http://localhost:3000/user', 'http://localhost/api/core/userBind/notify', 1658831880294, '08c679e45f924926a2b91c10afb8b192', '123456', 0, '2022-07-26 18:38:10', '2022-07-26 18:38:10', 0);
...
CREATE TABLE `user_invest`  (
  ...
  `status` tinyint(0) NOT NULL DEFAULT 0 COMMENT '状态（0：默认 1：已放款 -1：已撤标）',
  `create_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `is_deleted` tinyint(0) NOT NULL DEFAULT 0 COMMENT '逻辑删除(1:已删除，0:未删除)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户投资表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of user_invest
-- ----------------------------
INSERT INTO `user_invest` VALUES (7, 'ddd1066e996f45a5bf735d54deff86b5', '08c679e45f924926a2b91c10afb8b192', 'LEND20220726194922849', '买房贷款', 'INVEST20220727103301107', 100000.00, 0.00, 0.00, 100000.00, '', 1, '2022-07-27 10:33:08', '2022-07-27 10:37:58', 0);
...
CREATE TABLE `user_item_return`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `user_return_id` bigint(0) NOT NULL DEFAULT 0 COMMENT '还款id',
  ...
  `is_deleted` tinyint(0) NOT NULL DEFAULT 0 COMMENT '逻辑删除(1:已删除，0:未删除)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户还款明细表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `user_return`  (
  ...
  `is_deleted` tinyint(0) NOT NULL DEFAULT 0 COMMENT '逻辑删除(1:已删除，0:未删除)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户还款表' ROW_FORMAT = Dynamic;
